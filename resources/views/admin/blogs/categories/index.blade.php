    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="tableDiv">
                ...
                <hr>
                <div style="width: 100%;">
                    <button class="add"><a href="blog_cate/add" style="color: #ffffff;"><i
                                class="fas fa-plus"></i>Thêm danh mục bài viết</a></button>
                ...
                <table class="table table-striped">
                    ...
                    @foreach ($blog_cate as $blog)
                        <tr>
                            <td>{{ $blog->id }}</td>
                            <td>{{ $blog->name}}</td>
                            <td><a class="color" href="blog/detail/{{ $blog->id }}"><i
